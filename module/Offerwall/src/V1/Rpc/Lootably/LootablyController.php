...
class LootablyController extends AbstractActionController
{
    /**
    ...
    public function lootablyAction()
    {
        ...
        if($request->isGet()) {
            ...
            if (isset($_REQUEST['authkey'])) {
                $ayetPBKey = $this->mSecTools->getCoreSetting('lootably-pb-key');
                if($ayetPBKey) {
                    ...
                    if ($checkKey == $ayetPBKey) {
                        ...
                        if($oCheck->count() == 0) {
                            ...
                            $checkRepeat = true;
                            $ayetWhiteList = $this->mSecTools->getCoreSetting('loot-whitelist-offers');
                            if($ayetWhiteList) {
