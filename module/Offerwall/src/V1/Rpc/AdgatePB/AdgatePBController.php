...
class AdgatePBController extends AbstractActionController
{
    /**
    ...
    public function adgatePBAction()
    {
        ...
        if($request->isGet()) {
            ...
            if (isset($_REQUEST['authkey'])) {
                $ayetPBKey = $this->mSecTools->getCoreSetting('adgate-pb-key');
                if($ayetPBKey) {
                    ...
                    if ($checkKey == $ayetPBKey) {
                        ...
                        /**
                        $timeSecret = $this->mSecTools->getCoreSetting('adgate-secret');
                        if($_SERVER['REMOTE_ADDR'] != $timeSecret) {
                        ...
                        if($oCheck->count() == 0) {
                            ...
                            $hash = filter_var($_REQUEST['ran'], FILTER_SANITIZE_STRING);
